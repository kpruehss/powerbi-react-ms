(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-powerbi", ["react"], factory);
	else if(typeof exports === 'object')
		exports["react-powerbi"] = factory(require("react"));
	else
		root["react-powerbi"] = factory(root["react"]);
...
var _powerbiClient = __webpack_require__(3);

var pbi = _interopRequireWildcard(_powerbiClient);
...
var PowerbiEmbedded = function (_React$Component) {
  _inherits(PowerbiEmbedded, _React$Component);

  function PowerbiEmbedded(props) {
    _classCallCheck(this, PowerbiEmbedded);

    var _this = _possibleConstructorReturn(this, (PowerbiEmbedded.__proto__ || Object.getPrototypeOf(PowerbiEmbedded)).call(this, props));
  ...
  _createClass(PowerbiEmbedded, [{
    ...
    value: function validateConfig(config) {
      console.log(config);
      var errors = pbi.models.validateReportLoad(config);
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'powerbi-frame', ref: function ref(el) {
